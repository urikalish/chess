...
export class BotWorker {
	static bots = {
		bot0: new Bot(1, BotWorker.handleBotProgress),
		bot1: new Bot(2, BotWorker.handleBotProgress),
		bot2: new Bot(3, BotWorker.handleBotProgress),
		bot3: new Bot(4, BotWorker.handleBotProgress),
		bot4: new Bot(5, BotWorker.handleBotProgress),
	};
